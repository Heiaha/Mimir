        ...
        for line in lines:
            ...
            if random.random() < train_frac:
                ...
                if len(train_data) > file_length:
                    (
                        pl.DataFrame(train_data, schema_overrides={"fen": pl.String, "cp": pl.Int16, "result": pl.Float32})
                ...
                if len(test_data) > file_length:
                    (
                        pl.DataFrame(test_data, schema_overrides={"fen": pl.String, "cp": pl.Int16, "result": pl.Float32})
